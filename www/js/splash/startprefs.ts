 ...
 * @returns {boolean} if the consent is marked in the local var, considering whether consent is
 *    marked and whether the approval date matches the required approval date
 */
